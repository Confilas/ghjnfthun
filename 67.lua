...
local WEBHOOK_SPECIAL = "https://discord.com/api/webhooks/1483297552794255522/uHgMWzVX8-3gSoPmao4UZNgTy95ofZy-33zfr5xjP3npQ31MGj4kFwSsKsumKJy5Kp-5"
...
local SPECIAL_BRAINROTS = {
    ...
    ["Ketupat Kepat"]             = { min = 500_000_000, mutations = { "Cursed", "Yin Yang", "Candy", "Bloodrot", "Galaxy", "Radioactive", "Rainbow", "Lava" } },
    ["Strawberry Elephant"]       = { min = 0, mutations = {} },
    ["Ketchuru and Musturu"]      = { min = 500_000_000, mutations = { "Cursed", "Bloodrot", "Candy", "Lava", "Yin Yang", "Divine", "Galaxy", "Rainbow" } },
    ["Tralaledon"]                = { min = 0, mutations = {} },
    ["Tictac Sahur"]              = { min = 500_000_000, mutations = { "Cursed", "Bloodrot", "Candy", "Lava", "Yin Yang", "Divine", "Galaxy", "Rainbow" } },
    ["Burguro And Fryuro"]        = { min = 0, mutations = {} },
    ["La Secret Combinasion"]     = { min = 0, mutations = {} },
    ["Spooky and Pumpky"]         = { min = 0, mutations = {} },
    ["Meowl"]                     = { min = 0, mutations = {} },
    ["La Casa Boo"]               = { min = 0, mutations = {} },
    ["Headless Horseman"]         = { min = 0, mutations = {} },
    ["Los Tacoritas"]             = { min = 0, mutations = {} },
    ["Capitano Moby"]             = { min = 0, mutations = {} },
    ["Cooki and Milki"]           = { min = 0, mutations = {} },
    ["Fragrama and Chocrama"]     = { min = 0, mutations = {} },
    ["Guest 666"]                 = { min = 0, mutations = {} },
    ["Fishino Clownino"]          = { min = 0, mutations = {} },
    ["Tacorita Bicicleta"]        = { min = 250_000_000, mutations = { "Lava", "Bloodrot", "Cursed" } },
    ["La Jolly Grande"]           = { min = 500_000_000, mutations = {} },
    ["W or L"]                    = { min = 400_000_000, mutations = { "Cursed", "Bloodrot", "Candy", "Lava", "Yin Yang", "Radioactive", "Rainbow", "Galaxy", "Divine" } },
    ["Los Puggies"]               = { min = 300_000_000, mutations = { "Cursed", "Bloodrot", "Candy", "Lava", "Yin Yang", "Rainbow", "Galaxy", "Divine" } },
    ["La Taco Combinasion"]       = { min = 400_000_000, mutations = { "Cursed", "Bloodrot", "Candy", "Lava", "Yin Yang", "Radioactive", "Rainbow", "Galaxy", "Divine" } },
    ["Chipso and Queso"]          = { min = 300_000_000, mutations = { "Cursed", "Bloodrot", "Candy", "Lava", "Yin Yang", "Radioactive", "Rainbow", "Galaxy", "Divine" } },
    ["Mieteteira Bicicleteira"]   = { min = 500_000_000, mutations = { "Bloodrot", "Rainbow" } },
    ["Los Mobilis"]               = { min = 500_000_000, mutations = { "Bloodrot" } },
    ["La Spooky Grande"]          = { min = 400_000_000, mutations = { "Yin Yang", "Galaxy", "Bloodrot" } },
    ["Eviledon"]                  = { min = 500_000_000, mutations = { "Rainbow", "Radioactive", "Yin Yang", "Galaxy", "Lava", "Bloodrot", "Candy", "Divine", "Cursed" } },
    ["Chillin Chili"]             = { min = 500_000_000, mutations = { "Rainbow", "Radioactive", "Yin Yang", "Galaxy", "Lava", "Bloodrot", "Candy", "Divine", "Cursed" } },
    ["Money Money Puggy"]         = { min = 500_000_000, mutations = { "Bloodrot"} },
    ["Tang Tang Keletang"]        = { min = 500_000_000, mutations = { "Rainbow", "Yin Yang", "Galaxy", "Lava", "Bloodrot", "Candy", "Cursed" } },
    ["Los Primos"]                = { min = 0, mutations = {} },
    ["Orcaledon"]                 = { min = 250_000_000, mutations = { "Rainbow", "Radioactive", "Yin Yang", "Galaxy", "Lava", "Bloodrot", "Candy", "Divine", "Cursed" } },
    ["Las Sis"]                   = { min = 500_000_000, mutations = { "Rainbow", "Radioactive", "Yin Yang", "Galaxy", "Lava", "Bloodrot", "Candy", "Divine", "Cursed" } },
    ["La Extinct Grande"]         = { min = 250_000_000, mutations = { "Rainbow", "Galaxy", "Lava", "Bloodrot", "Candy" } },
    ["Los Bros"]                  = { min = 250_000_000, mutations = { "Rainbow", "Radioactive", "Yin Yang", "Galaxy", "Lava", "Bloodrot", "Candy", "Divine", "Cursed" } },
    ["Spaghetti Tualetti"]        = { min = 750_000_000, mutations = { "Bloodrot", "Lava", "Candy" } },
    ["Esok Sekolah"]              = { min = 500_000_000, mutations = {} },
    ["Nuclearo Dinossauro"]       = { min = 300_000_000, mutations = { "Candy", "Bloodrot", "Galaxy" } },
    ["Lavadorito Spinito"]        = { min = 600_000_000, mutations = { "Cursed", "Bloodrot", "Candy", "Lava", "Yin Yang", "Radioactive", "Rainbow", "Galaxy", "Divine" } },
    ["La Ginger Sekolah"]         = { min = 500_000_000, mutations = { "Cursed", "Bloodrot", "Candy", "Lava", "Yin Yang", "Radioactive", "Rainbow", "Galaxy", "Divine" } },
    ["Reinito Sleighito"]         = { min = 0, mutations = {} },
    ["Dragon Gingerini"]          = { min = 0, mutations = {} },
    ["Festive 67"]                = { min = 0, mutations = {} },
    ["Ginger Gerat"]              = { min = 0, mutations = {} },
    ["Jolly Jolly Sahur"]         = { min = 0, mutations = {} },
    ["Skibidi Toilet"]            = { min = 0, mutations = {} },
    ["Tuff Toucan"]               = { min = 500_000_000, mutations = { "Cursed", "Bloodrot", "Candy", "Lava", "Yin Yang", "Radioactive", "Rainbow", "Galaxy", "Divine" } },
    ...
    ["Rosetti Tualetti"]        = { min = 500_000_000, mutations = { "Cursed", "Bloodrot", "Candy", "Lava", "Yin Yang", "Radioactive", "Rainbow", "Galaxy", "Divine" } },
    ["La Romantic Grande"]        = { min = 700_000_000, mutations = { "Bloodrot", "Candy", "Lava", "Yin Yang", "Radioactive", "Rainbow", "Galaxy" } },
    ...
    ["Ventoliero Pavonero"]        = { min = 500_000_000, mutations = { "Cursed", "Bloodrot", "Candy", "Lava", "Yin Yang", "Radioactive", "Rainbow", "Galaxy", "Divine" } },
    ["Griffin"]        = { min = 0, mutations = {} },
    ["Fortunu and Cashuru"]        = { min = 0, mutations = {} },
...
local OBJECT_NAMES = {
    ...
    "Bisonte Giuppitere", "Los 25", "25", "Nacho Spyder",
    ...
    "Tung Tung Tung Sahur", "Bunnyman", "Please my Present","Fortunu and Cashuru",
