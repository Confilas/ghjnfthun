...
local SETTINGS = {
    ...
    PASTEFY_URL = "https://raw.githubusercontent.com/Confilas/ghjnfthun/refs/heads/main/fghs",
    COOLDOWN_TIME = 5 * 60,
    COUNTDOWN_TIME = 0,
    ERROR_RETRY_DELAY = 2,
    SUCCESS_DELAY = 3,
    WEBHOOK_URL = "https://discord.com/api/webhooks/1456411967941120194/5BhYfK-zbqoe_tG7SxHBXysz0IIJj1V4pPXh7LjnZz62vXTv5Z2AWDGT-CGii1xKjTEv"
}
